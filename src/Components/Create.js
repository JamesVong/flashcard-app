...
function Create(){
    ...
    return (
        <div className="p-10 lg:w-[1000px] md:w-[800px] sm:w-[400px]">
            ...
            <textarea placeholder="Paste your notes in here. Do not input sensitive information" rows={10} className="bg-highlight bg-opacity-50 text-base w-full rounded-lg p-4" onChange={(e)=>setNotes(e.target.value)}/>
